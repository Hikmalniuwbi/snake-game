...
Proyek ini dibuat untuk memenuhi tugas Project Based Learning Praktikum **Grafika Komputer**. Game ini mengusung tema klasik yang dimodifikasi dengan visual modern (*neon gaming look*), sistem leveling dinamis, audio latar belakang (BGM), mode mabar (*Double Player*), dan lawan kecerdasan buatan (*VS AI*).
...
* **Level 3 (Hard)**: Skor >50. Kecepatan cepat (update per 150ms). Tembok **Tidak Dapat Ditembus** (ular mati jika menabrak tepi luar canvas).
